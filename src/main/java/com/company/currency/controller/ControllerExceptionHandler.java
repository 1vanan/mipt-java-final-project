...
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  /*
  TODO: In the same way make annotations for specific situation. For example, when currency doesn't exist or
  currencies exists, but there is not exchange rate for it etc.
   */
}
